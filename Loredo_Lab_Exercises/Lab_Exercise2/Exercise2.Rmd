...
```
```{r}
write.csv(frame1, "1st_25Products.csv")

read.csv("1st_25Products.csv")
```
...
```{r}
write.csv(frame2, "2nd_25Products.csv")

read.csv("2nd_25Products.csv")
```
...
```{r}
write.csv(Reviewsdf, "50ProductsReviews.csv")

read.csv("50ProductsReviews.csv")
```
